        ...
        let topDist = math.abs(window.pageYOffset + document.getElementById('test').getBoundingClientRect().top);
        document.getElementsByClassName('modal').style.top = topDist.toString() + "px";
        }
